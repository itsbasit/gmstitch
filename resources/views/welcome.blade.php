...
<head>
    ...
    <title>SM Tailors & Drapers </title>
    <link rel="icon" href="{{ asset('/brandlogo.png') }}" />

    <!-- Fonts -->
    <link href="https://fonts.googleapis.com/css2?family=Nunito:wght@400;600;700&display=swap" rel="stylesheet">
    <link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/bootstrap/4.4.1/css/bootstrap.min.css" <!-- Styles
        -->
...
<body class="antialiased">
    <div
        ...
        @if (Route::has('login'))
            <div class="  top-0 right-0  col-sm">
                @auth
                    <a href="{{ url('/dashboard') }}"
                        class="text-sm text-gray-700 dark:text-gray-500 underline">Dashboard</a>
                @else
                    <a href="{{ route('login') }}"
                        class=" text-gray-700 dark:text-gray-500 underline btn btn-info text-right mt-5">Log in</a>

                       {{--  @if (Route::has('register'))
                                <a href="{{ route('register') }}"
                                    class="ml-4 text-sm text-gray-700 dark:text-gray-500 underline btn btn-warning">Register</a>
                        @endif --}}
                @endauth
            </div>
        @endif
        ...
        <div class="col-sm">
            <img src="{{ asset('/brandlogo.png') }}" alt="registerlogo" width="700" height="500"
                class="rounded mx-auto d-block img-responsive img-fluid">
        </div>
