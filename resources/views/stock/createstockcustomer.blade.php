...
@section('content')
    <a href="{{ route('stockcustomer.index') }}"><button class=" ml-3 btn btn-primary btn-sm mt-3 mb-3">Back To
            List</button></a>
    <div class="container-fluid ">
        <h1 class="p-3 "><b>+Create Customer Stock</b></h1>
    </div>
    <br>
    ...
    <div class="card" style="border-radius:30px">
        ...
        <div class="card-body">
            ...
            <form action="{{ route('stockcustomer.store') }}" method="post" enctype="multipart/form-data">
                <div class="form-group">
                    <div class="form-row">
                        @csrf
                        <div class="form-group col-lg-4">
                            <label for=""">Customer Name<i class="    fas fa-street-view"></i></label>
                        ...
                        <div class="form-group col-lg-6">
                            <label for=""> Price <i class="fas fa-mobile-alt"></i></label>
