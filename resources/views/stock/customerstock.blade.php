...
@section('content')
    <div class="container-fluid">
        <section class="content">
            <a class="btn btn-primary btn-sm mt-3 rounded-pill p-2" href="{{ route('stockcustomer.create') }}"><b>
                    ADD Stock Customer</b> <i class="fas fa-user-plus"></i></a>
            ...
            <div class="card mt-4" style="border-radius : 25px">
                <div class="card-header">
                    <h1 class="mt-3 "><b> <i>Stock Customer</i> </b> <i class="fas fa-user-tie"></i> </h1>
                    ...
                    <table class="table table-bordered table-striped table-hover text-center" id="myTable">
                        <thead>
                            <tr>
                                ...
                                <th>NAME <i class="fas fa-marker"></i></th>
                                <th>Brand <i class="fas fa-highlighter"></i></th>
                                <th>Brand Type <i class="fas fa-calculator"></i></th>
                                <th>Quantity <i class="fas fa-money-bill-wave-alt"></i></th>
            ...
            <script>
                $(document).ready(function() {
                    $('#myTable').DataTable({
                        ...
                        serverSide: true,
                        responsive: true,
                        ajax: "{{ route('stockcustomer.index') }}",
                        columns: [{
                                data: 'id',
                                name: 'id'
                            },
