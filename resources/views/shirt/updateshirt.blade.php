...
@section('title', 'Update Shirt')

@section('content')
    <a href="{{ route('shirt.index') }}"><button class=" ml-3 btn btn-primary btn-sm mt-3 mb-3">Back To
            List</button></a>
    <div class="container-fluid ">
        <h1 class="p-3 "><b>+Update Shirt</b></h1>
    </div>
    <br>
    ...
    <div class="card" style="border-radius:30px">
        ...
        <div class="card-body">
            ...
            <form action="{{ route('shirt.update', $customer->id) }}" method="POST">
                @csrf
                @method('put')
                ...
                <div class="form-group">
                    <div class="form-row">
                        ...
                        <div class="form-group col-lg-4">
                            ...
                            <input type="text" value="{{$customer->front_pocket_design}}" name="front_pocket_design" class="form-control">
                        </div> 
